...
* [X] Airports cannot give clearance to land if a weather check returns "stormy".
* [X] Airports cannot give clearance to take off if a weather check returns "stormy".